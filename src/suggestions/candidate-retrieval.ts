...
import { RETRIEVAL_TOP_K_PER_CHANNEL } from "./suggestion-constants.ts";
import { resolveCandidateProfiles } from "./candidate-resolution.ts";
import {
  expectedRoleForChannel,
  mergeVectorHits,
} from "./retrieval-utils.ts";
import type { RetrievalRequest, RetrievalResult, VectorHit } from "../types/conversation.retrieval";
