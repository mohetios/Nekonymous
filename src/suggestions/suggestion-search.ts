...
import { getPairStatesBatch } from "../storage/pair-ledger.client";
import {
  consumeSuggestionSearchBudget,
  getActiveExposureTokenHashes,
} from "../storage/user-state.client";
import type { Environment } from "../types/runtime.env";
import { rankCandidateProfiles } from "./suggestion-ranking.ts";
...
import { ELIGIBILITY_MAX_CONCURRENT_PAIR_LOOKUPS } from "./suggestion-constants.ts";
