import { CONVERSATION_DIMENSIONS } from "../profile/profile-constants.ts";
import type {
  ConversationDimension,
  ConversationProfile,
  ProfileLocale,
} from "../types/conversation.profile";
import {
  DIMENSION_FIT_ALIGNED,
  DIMENSION_FIT_DIFFERENCE,
  INTENT_SUGGESTION_BOOST,
  INTENT_MISSUGGESTION_PENALTY,
  MAX_ALIGNED_DIMENSIONS,
  MAX_DIFFERENCE_DIMENSIONS,
} from "./suggestion-ranking-constants.ts";
