export const SUGGESTION_DISCOVERABILITY_ENABLED =
...
export const SUGGESTION_INTRO_PROMPT =
  "یه پیام کوتاه برای شروع بنویس؛\n" +
  "چیزی که جواب‌دادن بهش راحت باشه.\n\n" +
  "گفت‌وگو فقط وقتی شروع می‌شه که طرف مقابل درخواستت رو بپذیره.";

export const SUGGESTION_INTRO_TEXT_ONLY =
  "پیام شروع باید متنی باشه و بیشتر از ۵۰۰ کاراکتر نباشه.";

export const SUGGESTION_INTRO_EMPTY =
  "پیام شروع نمی‌تونه خالی باشه.\n\nیه متن کوتاه بنویس.";

export const SUGGESTION_INTRO_TOO_LONG =
  "پیام شروع خیلی طولانیه.\n\nباید حداکثر ۵۰۰ کاراکتر باشه.";

export const SUGGESTION_REQUEST_SENT =
  "فرستادمش 🐾\n\nاگه قبولش کنه، بهت خبر می‌دم.";

export const SUGGESTION_ACCEPTED_CANDIDATE =
  "قبولش کردی.\n\nپیام شروعش توی صندوق پیام‌هاست.";

export const SUGGESTION_DECLINED_CANDIDATE =
  "درخواست رد شد.\n\nگفت‌وگویی شروع نمی‌شه.";

export const SUGGESTION_ACCEPTED_REQUESTER =
  "میو، درخواستت قبول شد 🐾\n\n" +
  "اگه طرف مقابل جواب بده، پیامش توی صندوقت میاد.";

export const SUGGESTION_DECLINED_REQUESTER =
  "درخواستت پذیرفته نشد.\n\nمی‌تونی بعداً گزینه‌های دیگه رو ببینی.";

export const SUGGESTION_INVALID = "این درخواست دیگه در دسترس نیست.";

export const SUGGESTION_RECENT_PAIR_COOLDOWN =
...
export const SUGGESTION_PENDING_EMPTY = "فعلاً درخواست گفت‌وگویی در انتظار پاسخ نداری.";
export const SUGGESTION_REQUEST_CANCELLED = "درخواست لغو شد.";
export const SUGGESTION_REQUEST_CANCEL_FAILED = "این درخواست دیگه در دسترس نیست.";

export const SUGGESTION_HUB_STATUS = {
...
export const formatSuggestionHubMessage = (params: {
  ...
  (params.profileSummaryHtml
    ? `\n\n<b>خلاصه‌ی پروفایل گفت‌وگو</b>\n${params.profileSummaryHtml}\n\n${SUGGESTION_PROFILE_PRIVACY_NOTE}`
    : "\n\n<b>خلاصه‌ی پروفایل گفت‌وگو</b>\nبرای شروع، ارزیابی سبک گفت‌وگو رو کامل کن.") +
  "\n\n<b>اقدام بعدی</b>\nاز دکمه‌های پایین انتخاب کن.";

export const SUGGESTION_PROFILE_PRIVACY_NOTE =
  "<i>این خلاصه فقط برای پیشنهاد گفت‌وگو استفاده می‌شه و نتیجه‌ی تست شخصیت یا تعریف قطعی تو نیست.</i>";

export const SUGGESTION_PROFILE_NO_ASSESSMENT =
  "هنوز پروفایل گفت‌وگو نداری.\n\n" +
  "اول ارزیابی سبک گفت‌وگو رو کامل کن.";

export const SUGGESTION_PROFILE_FAILED =
  "فعلاً نتونستم پروفایل گفت‌وگوت رو باز کنم.\n\n" +
  "کمی بعد دوباره امتحان کن؛ اگه مشکل موند، ارزیابی رو از نو انجام بده.";

export const SUGGESTION_SEARCH_INDEX_PENDING =
  "دارم پروفایلت رو برای پیشنهادهای گفت‌وگو آماده می‌کنم.\n\n" +
  "کمی بعد دوباره سر بزن.";

export const SUGGESTION_CANDIDATES_HEADER = "میو، یه گزینه برای گفت‌وگو پیدا کردم 🐾";
export const SUGGESTION_CANDIDATES_WHY_FIT = "چیزهایی که بینتون نزدیکه:";
export const SUGGESTION_INCOMING_WHY_FIT = "چیزهایی که بینتون نزدیکه:";
export const SUGGESTION_INCOMING_INTRO_LABEL = "پیام شروع:";

export const SUGGESTION_INCOMING_ACCEPT_NOTE =
