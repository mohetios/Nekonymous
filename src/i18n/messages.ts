...
متن پیام تا اولین نمایش موفق در صندوق، به‌صورت رمزنگاری‌شده نگه‌داری می‌شه. بعد از نمایش، متن کامل از فضای ذخیره‌سازی نکو پاک می‌شه.
...
https://mohetios.github.io/Nekonymous/
