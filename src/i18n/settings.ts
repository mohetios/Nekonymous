...
export const SETTINGS_PAUSE_ENABLE_DESC = "دریافت پیام‌های جدید را دوباره فعال می‌کند";
export const SETTINGS_PAUSE_DISABLE_DESC = "دریافت پیام‌های جدید را موقتاً متوقف می‌کند";
...
این یک خلاصه‌ی قابل خواندن از معماری ربات است؛ نه مستند کامل کد.
...
• ارزیابی سبک گفت‌وگو برای فهم مرزها، عمق گفت‌وگو، انرژی اجتماعی و ترجیح‌های ارتباطی
• پیشنهاد گفت‌وگوی اختیاری بر اساس پروفایل کنترل‌شده‌ی ارزیابی

<b>ذخیره‌سازی و مسئولیت‌ها</b>
...
• Workers AI + Vectorize: embedding پروفایل کنترل‌شده و کشف اولیه‌ی گزینه‌ها
...
• بعد از تحویل در صندوق پیام‌ها، متن پیام از storage پاک می‌شود و فقط metadata رمزنگاری‌شده‌ی لازم برای callbackها باقی می‌ماند.
