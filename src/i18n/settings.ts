...
export const SETTINGS_PAUSE_DISABLE_DESC = "توقف موقت دریافت پیام‌های جدید";
...
این عملیات قابل بازگشت نیست. همهٔ داده‌های شما به‌طور دائمی حذف می‌شود:
• لینک فعلی و همه لینک‌های قبلی
• صندوق، بلاک‌ها، نام‌های خصوصی و پیش‌نویس‌ها
• پروفایل ارزیابی، تاریخچه مچ و وکتور مچ‌یابی
• رکوردهای D1 مرتبط با حساب شما

فقط آمار کلی ناشناس سامانه (تعداد پیام، ارزیابی و درخواست مچ) بدون شناسه شما باقی می‌ماند.

بعد از تأیید، یک <b>حساب و لینک کاملاً جدید</b> دریافت می‌کنید.
...
export const SETTINGS_RESET_MATCH_REQUESTS_CLEARED =
  "— COUNT درخواست مچ حذف شد";
export const SETTINGS_RESET_MATCH_BLOCKS_CLEARED = "— COUNT بلاک مچ حذف شد";
