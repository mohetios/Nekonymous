...
export const MATCH_PRODUCT_FRAMING =
  "پیشنهادهای گفت‌وگو بر اساس سیگنال‌هایی مثل سبک گفت‌وگو، مرزها، عمق، انرژی اجتماعی و شباهت معنایی پروفایل ارزیابی ساخته می‌شوند.\n\n" +
  "این سیستم تشخیص روان‌شناختی، درمان، پیشنهاد رابطه یا ضمانت سازگاری نیست.";

export const MATCH_NO_PROFILE =
  "برای دیدن پیشنهادهای گفت‌وگو، اول باید ارزیابی سبک گفت‌وگو را کامل کنی.";
...
export const MATCH_PROFILE_VERSION_OUTDATED =
  ...
  "تا وقتی ارزیابی جدید را کامل نکنی، پیشنهادهای گفت‌وگو با نتیجه‌ی قبلی ادامه پیدا می‌کنند.";

export const MATCH_VECTOR_PENDING =
  "نتیجه‌ی ارزیابی آماده است، اما پروفایل گفت‌وگو هنوز برای جست‌وجو آماده نشده است.\n" +
  "چند لحظه بعد دوباره امتحان کن.";

export const MATCH_VECTOR_FAILED =
  "پروفایل گفت‌وگو هنوز برای جست‌وجو آماده نشده است.\n" +
  "می‌توانی دوباره تلاش کنی یا کمی بعد برگردی.";

export const MATCH_OPT_IN =
  "در حال حاضر در پیشنهادهای گفت‌وگو نمایش داده نمی‌شوی.\n\n" +
  "اگر بخواهی، می‌توانی نمایش را فعال کنی تا دیگران هم در صورت نزدیکی سبک گفت‌وگو، برایت درخواست گفت‌وگو بفرستند.\n\n" +
  "هویت تلگرام، لینک شخصی و نتیجه‌ی کامل ارزیابی به دیگران نمایش داده نمی‌شود.";
...
export const MATCH_ENABLED =
  "نمایش در پیشنهادهای گفت‌وگو فعال شد.\n" +
  "پروفایل تو فقط برای ساخت پیشنهادهای ناشناس استفاده می‌شود؛ هویت تلگرام و نتیجه‌ی کامل ارزیابی نمایش داده نمی‌شود.";
...
export const MATCH_SEARCH_LIMIT =
  "برای جلوگیری از فشار روی سیستم، جست‌وجو محدود شده است. کمی بعد دوباره امتحان کن.";
...
export const MATCH_NO_CANDIDATES =
  "فعلاً گزینه‌ی مناسبی برای نمایش پیدا نشد. بعداً دوباره امتحان کن.";

export const MATCH_NO_CANDIDATES_COOLDOWN =
  "فعلاً گزینه‌ی تازه‌ای برای پیشنهاد وجود ندارد.\n\n" +
  "درخواست‌هایی که اخیراً پذیرفته یا رد شده‌اند، تا ۳۰ روز دوباره در جست‌وجو نشان داده نمی‌شوند.\n\n" +
  "اگر می‌خواهی همان افراد دوباره در جست‌وجو دیده شوند، از تنظیمات → «♻️ بازنشانی پیشنهادها» استفاده کن.";

export const MATCH_INTRO_PROMPT =
  "اگر دوست داری، یک پیام کوتاه و کم‌فشار برای شروع گفت‌وگو بنویس.\n\n" +
...
export const MATCH_ACCEPTED_CANDIDATE =
  "درخواست را پذیرفتی. حالا می‌توانی گفت‌وگو را به‌صورت ناشناس ادامه بدهی.\n" +
  "از <code>/inbox</code> می‌توانی آن را ببینی و پاسخ بدهی.";

export const MATCH_DECLINED_CANDIDATE =
  "درخواست گفت‌وگو رد شد. هیچ گفت‌وگویی ساخته نشد.";

export const MATCH_ACCEPTED_REQUESTER =
  "طرف مقابل درخواست گفت‌وگو را پذیرفت. اگر پاسخ بدهد، پیام در صندوق پیام‌ها نمایش داده می‌شود.";
...
export const MATCH_PENDING_EXISTS =
  "یک درخواست گفت‌وگو بین شما در انتظار پاسخ است.\n" +
  "از «📥 درخواست‌های گفت‌وگو» در منوی پیشنهاد گفت‌وگو آن را ببین و مدیریت کن.";
...
export const MATCH_PENDING_LIST_HEADER =
  ...
  "دریافتی: {incoming} — ارسالی: {outgoing}\n\n" +
...
export const MATCH_REQUEST_CANCELLED =
  "درخواست گفت‌وگو لغو شد. می‌توانی دوباره جست‌وجو کنی یا درخواست تازه‌ای بفرستی.";
...
export const MATCH_SYSTEM_INTRO =
  "🧭 <b>پیشنهاد گفت‌وگو</b>\n\n" +
  "پیشنهاد گفت‌وگو یک قابلیت اختیاری است.\n\n" +
  "بعد از ارزیابی سبک گفت‌وگو، نکونیموس می‌تواند چند گزینه‌ی گفت‌وگوی نزدیک به الگوی فعلی تو پیشنهاد کند. این یک تست شخصیت، سیستم سازگاری دقیق یا قابلیت دوستیابی نیست.";

export const MATCH_PROFILE_PRIVACY_NOTE =
  "این پروفایل فقط برای خودت نمایش داده می‌شود.\n" +
  "اگر نمایش در پیشنهادها را فعال کنی، فقط برای ساخت پیشنهادهای ناشناس استفاده می‌شود؛ نتیجه‌ی کامل ارزیابی به دیگران نمایش داده نمی‌شود.";
...
export const MATCH_PROFILE_VECTOR_PENDING =
  "پروفایل ارزیابی ذخیره شده، اما آماده‌سازی پیشنهاد گفت‌وگو هنوز کامل نشده است.\n" +
...
export const MATCH_EXPLANATION_FALLBACK_REASON =
  "چند نقطه‌ی مشترک در سبک ارتباطی دیده می‌شود.";

export const MATCH_REASON_BOUNDARY = "در احترام به مرزها به هم نزدیک هستید.";
export const MATCH_REASON_DEPTH = "سبک گفت‌وگوی شما از نظر عمق به هم نزدیک است.";
export const MATCH_REASON_CONFLICT_REPAIR =
  "هر دو در سوءتفاهم‌ها تمایل به ترمیم گفت‌وگو دارید.";
