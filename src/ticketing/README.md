...
| callback resolution and ownership verification | `resolve-ticket-action.ts`, `message-service.ts` |
| reply/block/unblock/nickname/report handlers | `actions.ts` |
| message/deep-link handlers | `handlers.ts` |
| lifecycle and limits | `ticket-lifecycle.ts`, `../types/inbox.constants.ts` |
